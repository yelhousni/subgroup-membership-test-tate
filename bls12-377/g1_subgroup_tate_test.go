...
func TestG1SubGroupMembershipTate(t *testing.T) {
	...
	properties.Property("[BLS12-377] IsInSubGroupTate should output true for points on G1", prop.ForAll(
...
// BenchmarkG1IsInSubGroup benchmarks subgroup membership test
